...
class IPT_KB_KnowledgeBase_Widget extends WP_Widget {
  ...
  function form( $instance ) {
    ...
    ?>
<p>
  <label for="<?php echo $this->get_field_id( 'title' ); ?>"><strong>
    <?php _e( 'Title', 'ipt_kb' ) ?>
    </strong></label>
...
<p>
  ...
  <label for="<?php echo $this->get_field_id( 'show_sub' ); ?>">
    <?php _e( 'Show sub categories below the parent category (main knowledge bases)', 'ipt_kb' ); ?>
  </label>
</p>
<p class="description">
